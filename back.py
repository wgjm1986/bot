import json, sqlite3, openai, numpy as np
from flask import Flask, request, Response, stream_with_context
from get_document_text import get_document_text
...
def document_prompt(query,chat_history_messages):
    ...
    "I am teaching a college finance course. A student has asked a question. "
    ...
    "Below I will give you the student's question, and their previous conversation with the LLM. "
...
def keyword_prompt(query,chat_history_messages,document_choice):
    ...
    "I want you to reply with a list of one to four keywords that I can use in a search through my course documents to provide the LLM with additional context for the question. "
...
def query_LLM(query,chat_history_messages):
    ...
    "You are a helpful TA answering student questions in a college finance course. "
